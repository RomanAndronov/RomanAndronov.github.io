...
typedef struct bio
{
	...
	struct bio*	( *setNextDecorator )( struct bio*, struct bio* );
	struct bio*	( *getNextDecorator )( struct bio* );
...
extern bio_t*		bioSetNextDecorator( bio_t*, bio_t* );
extern bio_t*		bioGetNextDecorator( bio_t* );
