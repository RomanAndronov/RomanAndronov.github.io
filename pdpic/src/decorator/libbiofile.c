...
static bio_t*		bioSetNextDecoratorFile( bio_t*, bio_t* );
static bio_t*		bioGetNextDecoratorFile( bio_t* );
...
{ 
	...
	bioNameFile,
	bioSizeOffile,
	bioSetNextDecoratorFile,
	bioGetNextDecoratorFile,
	bioDestructFile
};
...
static bio_t*
bioGetNextDecoratorFile( bio_t* bio )
{
	biofile_t*	file = ( biofile_t* )bio;
	bio_t*		rv = file->nextDecorator;
